...
namespace Microsoft.Azure.Management.ApiManagement.ArmTemplates.Custom.Commands.Applications
{
    public class CreateApplicationMergeTemplatesCommand : IConsoleAppCommand<CreateConsoleAppConfiguration, CreatorConfig>
    {
        ...
        public CreateApplicationMergeTemplatesCommand(
        ...
        public async Task ExecuteCommandAsync(CreatorConfig creatorConfig)
        {
            ...
            Creator.TemplateCreators.DiagnosticTemplateCreator diagnosticTemplateCreator = new Creator.TemplateCreators.DiagnosticTemplateCreator();
            ...
            Creator.TemplateCreators.APITemplateCreator apiTemplateCreator = new Creator.TemplateCreators.APITemplateCreator(fileReader, policyTemplateCreator, productAPITemplateCreator, tagAPITemplateCreator, diagnosticTemplateCreator, releaseTemplateCreator, this.templateBuilder);
